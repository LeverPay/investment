...
import SuccessCheckmark from '../../components/success/SuccessCheckmark'
...
const Investment = () => {
    ...
    return (
        <div className='investmentPageForm'>
            <img alt='logo' src='/images/logo.png' className='i-logo' />
            {
                step === 1 && <div className='investment'>
                    <form onSubmit={handleForm}>
                        ...
                        {
                            states && states.length > 1 && <label className='sel-lab'>
                                State
                        ...
                        <div className='btns'>
                            <button type='submit'>{isSub ? <img alt='' className='loading' src='/images/loading.png'/> : 'Proceed to Payment'}</button>
